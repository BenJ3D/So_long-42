...
/*   Updated: 2022/04/12 16:22:17 by bducrocq         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	push_tile_to_win(t_data *game)
{
	...
	while (game->map.tile[index])
	{
		...
		if (game->map.tile[index] != GROUND || game->map.tile[index] != PLAYER) //FIXME:
		{
...
int	trace_player_to_win(t_data *game)
{
	...
	// index = 0;
	mlx_put_image_to_window(game->mlx, game->windows,
								game->player.png.img, sizepng * game->player.posx, sizepng * game->player.posy);
	game->player.posx++;
	index++;
	// while (game->map.tile[index])
	// {
	// 	// if (game->player.posx == game->map.lenx)
	// 	// 	{
	// 	// 		game->player.posx = 0;
	// 	// 		game->player.posy++;
	// 	// 		game->map.leny++; // dependance ? ou a virer
	// 	// 	}
		// if (game->map.tile[index] == PLAYER)
		// 	mlx_put_image_to_window(game->mlx, game->windows, 
		// 		game->item.img, sizepng * game->player.posx, sizepng * game->player.posy);
		// game->player.posx++;
		// index++;
	// }
	return (0);
